...
Route::middleware(['auth:sanctum', 'role:admin'])->group(function () {
    ...
    Route::get('rooms', [RoomController::class, 'index']); // Menampilkan semua room
...
Route::middleware(['auth:sanctum', 'role:user'])->group(function () {
    ...
    Route::get('/bookings/my/{bookingList}', [BookingListController::class, 'show'])->middleware('auth:sanctum'); // Menampilkan detail booking user sendiri
});
